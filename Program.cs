...
builder.Services.AddDbContext<Stetco_Bianca_Lab2Context>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("Stetco_Bianca_Lab2Context") ?? throw new InvalidOperationException("Connection string 'Stetco_Bianca_Lab2Context' not found.")));
